// Menu Functions
function creative_portfolio_lite_openNav() {
  jQuery(".sidenav").addClass('show');
}

function creative_portfolio_lite_closeNav() {
  jQuery(".sidenav").removeClass('show');
}

/////////////////////// Focus handling ///////////////////////
(function(window, document) {
  function creative_portfolio_lite_handleMobileMenuNavigation() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    creative_portfolio_lite_handleMobileMenuNavigation();
